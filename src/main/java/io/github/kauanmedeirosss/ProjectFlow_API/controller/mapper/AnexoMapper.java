...
import io.github.kauanmedeirosss.ProjectFlow_API.controller.dto.AnexoDetalheDTO;
...
public interface AnexoMapper {
    ...
    @Mapping(target = "uploadEm", source = "uploadEm")
    AnexoRetornoDTO toRetornoDTO(Anexo anexo);

    @Mapping(target = "tarefa_id", source = "tarefa.id")
    AnexoDetalheDTO toDetalheDTO(Anexo anexo);
